...
public class Day01 {
    ...
    public static void main(String[] args) {
        new Day01().doChallenge();
    }

    private static final String[] numberStrings = new String[]{"zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"};

    private static final Map<String, String> numberStringMap = Map.of(
        "zero", "0",
        "one", "1",
        "two", "2",
        "three", "3",
    ...
    private void doPart1(String input1) {
        ...
        for (String line : lines) {
            ...
            int combinedNumber = Integer.parseInt(firstDigit + lastDigit);
    ...
    private void doPart2(String input1) {
        ...
        for (String line : lines) {
            ...
            String lastDigit = "-1";
            for (int i = 0; i < line.length(); i++) {
                String singleDigit = line.substring(i, i + 1);
                try {
                    Integer.parseInt(singleDigit);
                    if (firstDigit.equals("-1")) {
                        firstDigit = singleDigit;
                    }
                    lastDigit = singleDigit;
                } catch (NumberFormatException ignored) {

                }
                String restOfString = line.substring(i);
                for (String numberString : numberStrings) {
                    if (restOfString.startsWith(numberString)) {
                        if (firstDigit.equals("-1")) {
                            firstDigit = numberStringMap.get(numberString);
                        }
                        lastDigit = numberStringMap.get(numberString);
                        break;
                    }
                }
            }
